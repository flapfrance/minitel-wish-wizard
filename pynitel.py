...
class Pynitel:
    ...
    def input(self, ligne, colonne, longueur, st = 15,data='',
    ...
    def waitzones(self, zone, time =30):
        ...
        while True:
            ...
            (self.zones[zone-1]['texte'], touche) = self.input(self.zones[zone-1]['ligne'],  # noqa
                self.zones[zone-1]['colonne'], self.zones[zone-1]['longueur'], time,
